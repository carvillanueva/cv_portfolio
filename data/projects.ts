export const projects = [
  ...
  },
  {
    ...
    projectURL: "https://villanueva_trash-system.vercel.app/",
    ghURL: null,
    projectTech: [
      "NextJS ",
      "Postgres",
    ...
    projectImg: "/assets/villanueva-trash.png",
  },
  {
    title: "BeautyLashesByGabby",
    description:
      "Designed and hosted a small business salon site. Site contains multi page layout with service details, booking form, and contact information.",
  ...
  },
  {
    ...
    description:
      "Created a Python web scraper to extract content data from a website and have chatbot to answer questions regarding the content.",
    projectURL: null,
  ...
  },
  {
    ...
    description:
      "Personal portfolio. Created on NextJs. Went for a design first approach.",
    projectURL: "https://carlos-villanueva.vercel.app/",
    ghURL: "https://github.com/carvillanueva/cv_portfolio",
    projectTech: ["NextJs", "Tailwind", "ShadcnUI", "Vercel", "JS/TS"],
    projectImg: "/assets/portfolio.png",
  },
  {
    title: "Wedding Website",
    description:
      "Designed and hosted personal wedding website. Site contains multi page layout with RSVP form, photo gallery, and event details.",
